...
export default function Login() {
  ...
  return (
    <div className="theme-fade" style={{
      ...
      <div className="blob" style={{ width: 380, height: 380, top: -100, left: -100, background: '#6366f1', animation: 'floatBlob1 10s ease-in-out infinite' }} />
      <div className="blob" style={{ width: 320, height: 320, bottom: -100, right: -80, background: '#8b5cf6', animation: 'floatBlob2 12s ease-in-out infinite' }} />
      <div className="blob" style={{ width: 240, height: 240, bottom: 60, left: '10%', background: '#22c55e', opacity: 0.15, animation: 'floatBlob1 14s ease-in-out infinite reverse' }} />
      ...
      <div className={`pop-in ${shake ? 'shake-anim' : ''}`} style={{
        ...
        <div className="pop-in" style={{
          width: 60, height: 60, borderRadius: 18, background: 'linear-gradient(135deg,#6366f1,#8b5cf6)',
          display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20,
          boxShadow: '0 8px 24px rgba(99,102,241,0.4)', animationDelay: '0.05s'
        }}>
          <MessageCircle color="white" size={28} />
        </div>

        <h1 style={{ color: isDark ? '#fff' : '#171717', fontSize: 21, fontWeight: 700, margin: 0, textAlign: 'center' }}>
          Chatly'ga xush kelibsiz
        </h1>
        ...
        <form onSubmit={handleLogin} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <button
            ...
            style={{
              width: '100%', boxSizing: 'border-box', background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', border: 'none',
